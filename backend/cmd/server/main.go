// Command server runs the chhootganit HTTP middleware.
package main
...
import (
	...
	"github.com/Sreenivas-Sadhu-Prabhakara/chhootganit/backend"
)
...
func main() {
	...
	log.Printf("chhootganit listening on %s", addr)
